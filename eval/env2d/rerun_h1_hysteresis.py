...
def run_adaptive_hysteresis(env, seed, astar_policy, bc_policy):
    ...
    while not done and steps < 200:
        ...
        steps += 1
    return bool(info.get("goal_reached", False)), switches
...
def main():
    ...
    for trial in range(args.trials):
        ...
        astar_ok = run_fixed(env, seed, "astar", astar_policy, bc)
        bc_ok = run_fixed(env, seed, "bc", astar_policy, bc)
        adaptive_ok, switches = run_adaptive_hysteresis(env, seed, astar_policy, bc)
